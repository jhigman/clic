...
public class MainActivity extends AppCompatActivity
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        BarEntry v1e1 = new BarEntry(r.nextInt(max), 0); // Jan
        valueSet1.add(v1e1);
        BarEntry v1e2 = new BarEntry(r.nextInt(max), 1); // Feb
        valueSet1.add(v1e2);
        BarEntry v1e3 = new BarEntry(r.nextInt(max), 2); // Mar
        valueSet1.add(v1e3);
        BarEntry v1e4 = new BarEntry(r.nextInt(max), 3); // Apr
        valueSet1.add(v1e4);
        BarEntry v1e5 = new BarEntry(r.nextInt(max), 4); // May
        valueSet1.add(v1e5);
        BarEntry v1e6 = new BarEntry(r.nextInt(max), 5); // Jun
        valueSet1.add(v1e6);
        BarEntry v1e7 = new BarEntry(r.nextInt(max), 6); // Jun
        valueSet1.add(v1e7);

        BarDataSet barDataSet1 = new BarDataSet(valueSet1, "Clicks");
